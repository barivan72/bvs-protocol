...
assert.ok(loader.includes('/rex-relax/icon-512.png?v=20260916-7'));
...
assert.ok(manifest.start_url.startsWith('/rex-relax/index.html'));
...
assert.ok(worker.includes('rex-relax-2026-09-16-7'));
assert.ok(worker.includes('icon-192.png?v=20260916-7'));
assert.ok(worker.includes('icon-512.png?v=20260916-7'));
console.log('Rex Relax release verified: standalone PWA, local app icons, 20 complete 60-minute extended tracks, five recorded 90-minute sessions, prices, oil questions, and client database preserved.');
