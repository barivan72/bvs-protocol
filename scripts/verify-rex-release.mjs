...
assert.ok(loader.includes('bec34c_a7671e7c66294f6ca18527bb3eb2c2cd~mv2.png'));
...
assert.ok(manifest.icons.some(i=>i.purpose==='maskable'&&i.sizes==='192x192'));
...
console.log('Rex Relax release verified: standalone PWA manifest, final app icons, 20 complete 60-minute extended tracks, five recorded 90-minute sessions, prices, oil questions, and client database preserved.');
